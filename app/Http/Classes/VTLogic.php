...
class VTLogic
{
    ...
    public static function createPdf($entityId, $entityType = null, $force = false, $a3 = false)
    {
        ...
        if ($htmlFile == null) {
            ...
            $c = (env('PDF_GEN') ?? "google-chrome")." --no-sandbox --headless --disable-gpu --print-to-pdf=".storage_path("app/".$pdfFileName)." --no-margins --no-footer ".storage_path("app/".$htmlFileName);
            exec($c);
